...
- **Aegis-X**: the long-term complete system hypothesis formed by SARN-Hybrid plus the Aegis runtime, retrieval, persistent memory, tools, verification, safety controls, multimodal adapters, and hardware profiles.
