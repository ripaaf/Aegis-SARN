...
| adaptive reasoning depth | model/runtime experiment | core spine | bounded workspace/search budget | 5+ | quality per total compute and halting calibration | proposed |
| hardware profiles | framework component | framework component | model/precision/context planner | 12 | on-device fit, latency, quality-floor tests | planned |
| quantization | deployment technique | training/deployment technique | distinct model artifacts | 12/13 | memory/latency/quality by task | planned |
| distillation | training technique | training/deployment technique | deployable student variants | 13 | student Pareto improvement and safety regression | proposed |
...
| superposition | representation phenomenon | research phenomenon | measured in SARN activations | 14 | interference and causal feature studies | research topic |
...
| polysemanticity | interpretation concern | research phenomenon | representation analysis | 14 | feature selectivity and causal tests | research topic |
...
| goal generalization | evaluation objective | research phenomenon | OOD instruction/constraint adherence | 3 onward | structural shifts and hidden constraints | required evaluation |
